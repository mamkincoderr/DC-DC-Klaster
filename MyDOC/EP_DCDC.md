...
$$ {\Large C_{б} \ge \dfrac{Q_g + I_{qbs} \cdot t_{полу} + Q_{ls}}{\Delta U} } ,~(5.11)$$
...
$$ {\Large Q_{б} = Q_g + I_{CC} \cdot t_{полу} + I_{обр} \cdot t_{полу} } ,~(5.12)$$
...
$$ {\Large C_{б} \ge \dfrac{Q_{б}}{\Delta U} } ,~(5.13)$$
...
$$ {\Large P_{вх} = k \cdot I_F \cdot U_F \cdot D } ,~(5.14)$$
...
$$ {\Large P_{вых} = k \cdot I_{CC} \cdot U_{др} + k \cdot Q_g \cdot U_{др} \cdot f } ,~(5.15)$$
