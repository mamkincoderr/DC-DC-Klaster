...
$$ {\huge U_{\text{ВВ}} = 2 D n\, U_{\text{НВ}} } \tag{1.2}$$
...
$$ {\huge U_{\text{НВ}} = \dfrac{D' \, U_{\text{ВВ}}}{n} } \tag{1.3}$$
...
$$ {\huge n\, U_{\text{НВ.макс}} \le U_{\text{ВВ.мин}} } \tag{1.4}$$
...
$$ {\huge P = \dfrac{n\, U_{\text{ВВ}}\, U_{\text{НВ}}\, \varphi (\pi - \varphi)}{2\pi^2 f L} } \tag{1.5}$$
