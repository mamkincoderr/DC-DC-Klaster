...
$$ {\huge U_{\text{ВВ}} = 2 \cdot D \cdot n \cdot U_{\text{НВ}} } ,\tag{1.2}$$
...
$$ {\huge U_{\text{НВ}} = \dfrac{D' \cdot U_{\text{ВВ}}}{n} } ,\tag{1.3}$$
...
$$ {\huge n \cdot U_{\text{НВ.макс}} \le U_{\text{ВВ.мин}} } ,\tag{1.4}$$
...
$$ {\huge P = \dfrac{n \cdot U_{\text{ВВ}} \cdot U_{\text{НВ}} \cdot \varphi \cdot (\pi - \varphi)}{2\pi^2 f L} } ,\tag{1.5}$$
...
$$ {\huge \varphi > \dfrac{\pi (d-1)}{2d} } ,\tag{1.6}$$

для моста НВ

$$ {\huge \varphi > \dfrac{\pi (1-d)}{2} } ,\tag{1.7}$$
